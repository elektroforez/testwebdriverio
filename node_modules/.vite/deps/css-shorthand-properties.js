...
// node_modules/css-shorthand-properties/index.js
var require_css_shorthand_properties = __commonJS({
  "node_modules/css-shorthand-properties/index.js"(exports, module) {
    (function(exports2) {
      var props = exports2.shorthandProperties = {
      ...
      exports2.isShorthand = function(property) {
        return props.hasOwnProperty(property);
      };
      exports2.expand = function(property, recurse) {
        if (!props.hasOwnProperty(property)) {
          return [property];
        }
        return props[property].map(function(p) {
          var longhand = p.substr(0, 1) === "-" ? property + p : p;
          return recurse ? exports2.expand(longhand, recurse) : longhand;
        });
      };
    })(function(root) {
...
export default require_css_shorthand_properties();
/*! Bundled license information:

css-shorthand-properties/index.js:
  (*!
   * https://github.com/gilmoreorless/css-shorthand-properties
   * MIT Licensed: https://gilmoreorless.mit-license.org/
   *)
*/
//# sourceMappingURL=css-shorthand-properties.js.map
